...
//TODO: currently only uses axioms 'specificity' to stratify (seems good enough)
public class IRIGeneralisationMiner {
    ...
    public IRIGeneralisationMiner(OWLOntology o) {
        this.ontology = o;
        this.stratify(); 
        this.mine();
    }
        ...
        for(Map.Entry<Integer,Set<SyntaxTree>> entry : this.specificity2tree.entrySet()){
            ...
            for(SyntaxTree t : toPartition){
                ...
                for(SyntaxTree r : regs){
                    if(IRIGeneralisation.exists(t,r)){
