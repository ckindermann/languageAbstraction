...
public class ClassFrameGroundGeneralisation {
    ...
    public ClassFrameGroundGeneralisation(ClassFrame frame){
    ...
    private boolean isIsomorphic(TreeMap<Integer,Set<SyntaxTree>> here, 
        ...
        for(Map.Entry<Integer,Set<SyntaxTree>> entry : here.entrySet()){
                ...
                if(!there.containsKey(weight)){
                    ...
                    if(!SetGroundGeneralisation.exists(trees,there.get(weight)))
                        return false;
                }
        }
        return true;
