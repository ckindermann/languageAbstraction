...
public class HierarchyNode {
    private int ID;
    private WeightedClassFrameGG classFrame; 
    ...
    public HierarchyNode(WeightedClassFrameGG f, Set<OWLClassExpression> i, int id){
        this.ID = id;
        this.classFrame = f;
    ...
    public WeightedClassFrameGG getFrame(){
