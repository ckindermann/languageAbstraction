...
public class ConstructorPreservanceBuilder extends TreeBuilder
    ...
    //BROKEN: private LogicalAxiomVisitor logicalAxiomVisitor;
...
//
    ...
    //don't add node if class is named
    private void addNode(OWLClassExpression expr){ 
        if(expr.isOWLClass()){
            return;//don't add leaves
        }
