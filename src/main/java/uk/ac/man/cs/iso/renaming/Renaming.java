...
public class Renaming {
    ...
    public static boolean exists(SyntaxTree s1, SyntaxTree s2) throws Exception {
        Renaming r = new Renaming(s1,s2);
        return r.exists(); 
    }

    public Renaming(SyntaxTree t1, SyntaxTree t2) throws Exception {
        this.g1 = t1.getTree();
        this.g2 = t2.getTree();
    ...
    private boolean exists(Graph<SyntaxNode,DefaultEdge> g1, Graph<SyntaxNode,DefaultEdge> g2) throws Exception { 
