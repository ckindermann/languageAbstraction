...
public class SymmetricDifferenceEdgesRenaming {
    ...
    public static boolean exists(Set<SyntaxTree> s1, Set<SyntaxTree> s2) {
        SymmetricDifferenceEdgesRenaming r = new SymmetricDifferenceEdgesRenaming(s1,s2);
        return r.exists(); 
    }

    public SymmetricDifferenceEdgesRenaming(Set<SyntaxTree> t1, Set<SyntaxTree> t2) {
