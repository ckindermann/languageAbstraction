...
public class AxiomCEPreservation {
    ...
    public static void main(String[] args) throws IOException , Exception{
        ...
        timer.go();
        AxiomCEPreservation coverage = new AxiomCEPreservation(ont,0.9);
        ...
        String cepFolder = output + "/classExpressionPreservanceCoverage";
        IOHelper.createFolder(cepFolder);
        ...
        for(Map.Entry<Integer,Set<SyntaxTree>> entry : kCoverage.entrySet()){
            ...
            for(SyntaxTree r : regularities){
                ...
                IOHelper.writeAppend(prominence + "," + r.getRoot().toString(),
                        cepFolder + "/" + ontologyName); 
            }
        } 
        //summary file
        IOHelper.writeAppend(formatRenaming, output + "/classExpressionPreservance");
