package uk.ac.man.cs.exp.axiomtypesets;
 ...
 */
public class AxiomTypeGroundGeneralisation {

    private static final Logger log = Logger.getLogger(String.valueOf(AxiomTypeGroundGeneralisation.class));
    ...
    public static void main(String[] args) throws IOException , Exception{
        ...
        timer.go();
        WeightedClassFrameGGMiner miner = new WeightedClassFrameGGMiner(ont);
        log.info(timer.stop("GG for " + ontologyName));

        int regularities = miner.getRegularity2instance().size();
        //System.out.println("size : " + miner.getRegularity2instance().size());
